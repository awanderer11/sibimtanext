      ...
      >
        ...
        {roles === "dosen" && (
          <>
            <NavItem
              icon={BsFillGridFill}
              onClick={() => router.push(`/dashboard/dosen/${nip}`)}
            >
              Dashboard
            </NavItem>
            <Divider />
            <NavItem
              icon={FiUser}
              onClick={() => router.push(`/myprofile/dosen/${nip}`)}
            >
              My Profile
            </NavItem>
            <Divider />
        ...
        {roles === "mahasiswa" && (
          <>
            <NavItem
              icon={BsFillGridFill}
              onClick={() => router.push(`/dashboard/mahasiswa/${nim}`)}
            >
              Dashboard
            </NavItem>
            <Divider />
            <NavItem
              icon={FiUser}
              onClick={() => router.push(`/myprofile/mhs/${nim}`)}
            >
              My Profile
            </NavItem>
            <Divider />
            ...
            <NavItem
              ...
              onClick={() => router.push(`/mahasiswa/pengajuanjudul/${nim}`)}
            >
              Pengajuan Judul
            </NavItem>
            <Divider />
            <NavItem
              ...
              onClick={() => router.push(`/mahasiswa/proposal/index/${nim}`)}
            >
              Proposal
            </NavItem>
            <NavItem
              icon={BsFillBookmarkFill}
              onClick={() => router.push(`/mahasiswa/hasil/index/${nim}`)}
            >
              Hasil
            </NavItem>
            <NavItem
              icon={BsFillBookmarkFill}
              onClick={() => router.push(`/mahasiswa/tutup/index/${nim}`)}
            >
              Tutup
            </NavItem>
            <Divider />
            <NavItem
              ...
              onClick={() => router.push(`/mahasiswa/laporan/${nim}`)}
            >
              Laporan
            </NavItem>
            <Divider />
